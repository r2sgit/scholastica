...
export const COURSE_MAP: CourseMapEntry[] = [
  ...
  { id: 4,  numeral: 'IV',    title: 'Hylomorphism',                     latin: 'Hylemorphismus',         act: 1, built: false,
    aim: 'Matter and form: the grid goes physical, down to the bottom of the stack.' },
  { id: 5,  numeral: 'V',     title: 'Substance, Suppositum, Person',    latin: 'Suppositum et Persona',  act: 1, built: false,
  ...
  { id: 7,  numeral: 'VII',   title: 'The Transcendentals',              latin: 'Transcendentalia',       act: 2, built: false,
    aim: 'The words that follow being everywhere — and the beautiful dispute.' },
  { id: 8,  numeral: 'VIII',  title: 'The Four Causes',                  latin: 'Quattuor Causae',        act: 2, built: false,
  ...
  { id: 11, numeral: 'XI',    title: 'Semiotics',                        latin: 'De Signis',              act: 3, built: false,
    aim: 'Signs you look at, and the sign you look through.' },
  { id: 12, numeral: 'XII',   title: 'Will, Appetite, and the Passions', latin: 'Voluntas et Passiones',  act: 3, built: false,
  ...
  { id: 14, numeral: 'XIV',   title: 'Virtues and Habits',               latin: 'De Virtutibus',          act: 4, built: false,
    aim: 'What practice builds. Your vine has been teaching this all along.' },
  { id: 15, numeral: 'XV',    title: 'The Grammar of Distinctions',      latin: 'Distinctiones',          act: 4, built: false,
    aim: "The referee's toolkit: every kind of distinction, named and drilled." },
  { id: 16, numeral: 'XVI',   title: 'Analogy of Being',                 latin: 'Analogia Entis',         act: 4, built: false,
    aim: 'How one word can be true of God and of breakfast without lying.' },
  { id: 17, numeral: 'XVII',  title: 'Method of the Summa',              latin: 'Modus Summae',           act: 4, built: false,
